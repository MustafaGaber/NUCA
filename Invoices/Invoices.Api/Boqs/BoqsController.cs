using NUCA.Invoices.Application.Boqs.Commands;
using NUCA.Invoices.Application.Boqs.Queries.GetBoq;
using NUCA.Invoices.Application.Boqs.Commands.CreateBoq;
using NUCA.Invoices.Application.Boqs.Commands.CreateItem;
using NUCA.Invoices.Application.Boqs.Commands.CreateSection;
using NUCA.Invoices.Application.Boqs.Commands.CreateTable;
using NUCA.Invoices.Application.Boqs.Commands.DeleteItem;
using NUCA.Invoices.Application.Boqs.Commands.DeleteSection;
using NUCA.Invoices.Application.Boqs.Commands.DeleteTable;
using NUCA.Invoices.Application.Boqs.Commands.UpdateBoq;
using NUCA.Invoices.Application.Boqs.Commands.UpdateItem;
using NUCA.Invoices.Application.Boqs.Commands.UpdateSection;
using NUCA.Invoices.Application.Boqs.Commands.UpdateTable;
...
namespace NUCA.Invoices.Api.Boqs
{
